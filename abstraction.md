...
| Power limit | **200W — ACTIVE (user reverted from 120W, Aug 13 ~17:50)**, auto-applied at launch by `run_pretrain_gpu_60k.sh` (non-fatal if sudo unavailable). Verified numbers on this card: 285W = ZERO gain (thermal throttle wall, 87–88°C); **200W = speed ceiling** (9.12 s/step / 7,183 tok/s, ~80°C); 120W = 11.49 s/step / 5,701 tok/s, 69°C (−26% speed for −11°C); 100W floor = 14.15 s/step / 4,632 tok/s. Script-applied → survives reboot/GPU-idle |
