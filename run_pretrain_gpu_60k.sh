...
# ── Power cap: 120W (user-tuned, valid 100-285W on 4070 Ti) — non-fatal if sudo fails ──
echo 'Kenpeter1234!' | sudo -S nvidia-smi -pl 120 > /dev/null 2>&1 \
  || echo "⚠️  Could not set power limit 120W (non-fatal, continuing)"
